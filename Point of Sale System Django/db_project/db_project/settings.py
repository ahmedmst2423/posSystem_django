...
AUTH_USER_MODEL = "pos_app.Operator"
...
SECRET_KEY = 'django-insecure-x^&@!pkyzv%326j1lyb_&^yrgt!klvc=290ytv%4-_e_(le_a$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'pos_app', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTHENTICATION_BACKENDS = [
    'pos_app.backends.OperatorBackend',
